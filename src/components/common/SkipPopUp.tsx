...
const SkipPopUp = () => {
  ...
  return (
    <>
       {selectedSkip && (
        <div className="fixed top-10 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 bg-gradient-to-t from-black/10 to-transparent shadow-2xl p-6 rounded-xl xs:w-96 xx:w-80 text-center z-50 animate-fade-in">
